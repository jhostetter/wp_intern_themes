...
class TF_Template_Options {
	...
	public function tf_render_metabox($post) {
            global $TF;
            $templates = new WP_Query(array('post_type'      =>'tf_template',
                                            'post_status'    =>'publish',
                                                                        'meta_query'	 =>array(
                                                                        'relation' => 'AND',
                                                                         array(
                        ...
                        <div class="tf_custom_select">
                            <select name="<?php echo self::PREFIX?>[template]" id="<?php echo self::PREFIX?>_template">
                                ...
                                <?php while ( $templates->have_posts() ) : $templates->the_post(); ?>
                                    <option <?php if($template_id==  get_the_ID()):?>selected="selected"<?php endif;?> value="<?php the_ID();?>"><?php the_title();?></option>
                                <?php endwhile; ?>
                            </select>
                        </div>
                    </div>
